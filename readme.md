...
- Usuarios objetivo: - **Primario:** personas con inversiones distribuidas en más de una plataforma (cripto + banco + broker) que hoy arman su patrimonio a mano en una planilla y no tienen ninguna vista unificada.
